...
loc.model <- "Data/Models/model_8_LungFunc"
setwd(loc)
...
qqPlot(pvalue, main="QQ of methylation model FEV05 = Meth + Batch + Covariates", cex.lab=font.mp, cex.axis=font.mp, cex.main=font.mp, cex.sub=font.mp)
