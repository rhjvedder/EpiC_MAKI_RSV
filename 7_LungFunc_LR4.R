...
loc.model <- "Data/Models/model_7_LungFunc"
setwd(loc)
...
qqPlot(pvalue, main="QQ of methylation model FEV05 = Meth + Batch", cex.lab=font.mp, cex.axis=font.mp, cex.main=font.mp, cex.sub=font.mp)
